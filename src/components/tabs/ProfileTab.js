...
class ProfileTab extends React.Component {
  constructor(props) {
    ...
    this.tProvider = new firebase.auth.FacebookAuthProvider();
  }
      ...
      <View style={styles.rootContainer}>
        {userStore.loggedIn ? (
          ...
          <View style={styles.centerContainer}>
            <Text className="font">You can use it without signing in but your playlists won't be saved to cloud</Text>
